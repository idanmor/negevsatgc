...
public class SatteliteStatusPanel extends ImageView implements PanelsWithClickInterface {
	...
	public SatteliteStatusPanel(BorderPane mainPane) {
		...
		this.setImage(Utils.getImageViewFromLocation(this.getClass(),"sattelite.png"));
